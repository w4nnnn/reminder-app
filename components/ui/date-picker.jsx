 ...
 * Menggunakan komponen shadcn/ui (Calendar, Popover, Button).
 * 
 * @example
 * ```jsx
 ...
 * ```
 * 
 * @param {Date|undefined} date - Nilai tanggal yang dipilih (controlled)
 * @param {function} setDate - Callback untuk mengubah nilai tanggal
 * @param {string} className - Class tambahan untuk tombol trigger
 * @param {string} placeholder - Teks placeholder saat belum ada tanggal dipilih
 */
        ...
        <Popover open={isOpen} onOpenChange={setIsOpen}>
                ...
                >
                    ...
                    {date ? (
                        <span className="font-medium">
                            {format(date, "EEEE, d MMMM yyyy 'pukul' HH:mm", { locale: id })}
                        </span>
                    ) : (
            ...
            >
                <div className="flex flex-col sm:flex-row">
                    ...
                    <div className="flex flex-col p-4 w-full sm:w-[180px] bg-muted/30">
